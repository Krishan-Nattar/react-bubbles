...
A token is sent by the server to authenticate a client. This way the client does not need to continuously send in login detail at every page request.

- [ ] What steps can you take in your web apps to keep your data secure?

Create an authentication system using tokens.

- [ ] Describe how web servers work.

A web server is a computer that will send data to a client when requested. It is generally on all the time.
